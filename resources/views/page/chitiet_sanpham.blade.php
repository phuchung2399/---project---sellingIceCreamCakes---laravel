			...
			<div class="col-sm-9">
				...
				<div class="row">
					...
					<div class="col-sm-8">
						...
						<div style="margin-left: -20px" class="single-item-options">
							...
							<div class="media beta-sales-item">
								...
								<div class="media-body">
									...
									<p class="single-item-price" style="font-size: 18px">
										...
										@else
										<span class="flash-sale single-item-title">{{number_format($new->promotion_price)}} đồng</span>
										<span class="flash-del single-item-title">{{number_format($new->unit_price)}} đồng</span>
										@endif
									</p>
								</div>
							</div>
