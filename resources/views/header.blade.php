			...
			<div class="container">
				<div class="pull-left auto-width-left">
					<ul class="top-menu menu-beta l-inline">
						<li><a href=""><i class="fa fa-home"></i> 98-99 Tô Hiến Thành, Sơn Trà, Đà Nẵng</a></li>
						<li><a href=""><i class="fa fa-phone"></i> (+84) 098 123 456</a></li>
					</ul>
				</div>
				...
				<div class="pull-right beta-components space-left ov">
					...
					<div class="beta-comp">
						...
						<input type="hidden" name="_token" value="{{csrf_token()}}">
					        <input type="text" class="searchProduct" name="country_name" id="country_name" placeholder="Nhập từ khóa..." />
							<div style="position: absolute" id="countryList"></div>
						</form>
					</div>
